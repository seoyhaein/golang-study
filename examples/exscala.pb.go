...
type ScalaTypes struct {
	...
	// 아래 코드가 없을때 테스트 해볼 것
	EnumAllowingAliasVar ScalaTypes_EnumAllowingAlias `protobuf:"varint,15,opt,name=EnumAllowingAlias_var,json=EnumAllowingAliasVar,proto3,enum=grpc_examples.ScalaTypes_EnumAllowingAlias" json:"EnumAllowingAlias_var,omitempty"`
	// 아래 코드가 없을때 테스트 해볼 것
	EnumNotAllowingAliasVar ScalaTypes_EnumNotAllowingAlias `protobuf:"varint,16,opt,name=EnumNotAllowingAlias_var,json=EnumNotAllowingAliasVar,proto3,enum=grpc_examples.ScalaTypes_EnumNotAllowingAlias" json:"EnumNotAllowingAlias_var,omitempty"`
...
func init() {
	proto.RegisterEnum("grpc_examples.ScalaTypes_EnumAllowingAlias", ScalaTypes_EnumAllowingAlias_name, ScalaTypes_EnumAllowingAlias_value)
	proto.RegisterEnum("grpc_examples.ScalaTypes_EnumNotAllowingAlias", ScalaTypes_EnumNotAllowingAlias_name, ScalaTypes_EnumNotAllowingAlias_value)
	proto.RegisterType((*ScalaTypes)(nil), "grpc_examples.ScalaTypes")
}
